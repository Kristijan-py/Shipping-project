...
dotenv.config();
import { authenticateToken, authorizeAdmin } from '../middleware/JWT-Error-Logger-Roles.js'; // To protect the routes

const router = express.Router();
import { getUsers, getUserById, getUserByEmail, updateUser, deleteUser } from '../src/database.js';
import { validateUserInput } from '../src/helperFunctions.js';
